...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    {
        $itemIds = $this->getRequest()->getParam('design');
        if (!is_array($itemIds) || empty($itemIds)) {
            ...
            try {
                ...
                foreach ($itemIds as $postId) {
                    $post = $this->_objectManager->get('OrviSoft\Designkeys\Model\Design')->load($postId);
        ...
        return $this->resultRedirectFactory->create()->setPath('designkeys/*/index');
    }
