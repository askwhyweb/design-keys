...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('OrviSoft_Designkeys::Design')
            ->addBreadcrumb(__('OrviSoft Designkeys'), __('OrviSoft Designkeys'))
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('OrviSoft\Designkeys\Model\Design');
        ...
        $this->_coreRegistry->register('design', $model);
